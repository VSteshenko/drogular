    ...
    > values_{
        {
            "en",
            {
                ...
                {"departments.search.clear", "Clear"},
                ...
                {"departments.members.empty", "This department has no members."},
                {"departments.members.add", "Add member"},
                {"departments.members.remove", "Remove"},
                {"departments.members.no_candidates", "All users already belong to this department."},
                {"departments.members.error.invalid", "The selected user is invalid."},
                {"departments.members.error.duplicate", "This user is already a member of the department."},
                {"departments.members.error.not_found", "The department member was not found."},
                {"departments.members.success.added", "Member added."},
                {"departments.members.success.removed", "Member removed."},
                {"departments.back", "Back to departments"},
                {"departments.status", "Status"},
                {"departments.pagination.label", "Department pages"},
                {"departments.filter.title", "Filters"},
                {"departments.filter.status", "Status"},
                {"departments.filter.all", "All statuses"},
                {"departments.filter.active", "Active"},
                {"departments.filter.inactive", "Inactive"},
                {"departments.sort.label", "Sort by"},
                {"departments.sort.direction.label", "Direction"},
                {"departments.sort.name", "Name"},
                {"departments.sort.manager", "Manager"},
                {"departments.sort.active", "Status"},
                {"departments.sort.id", "ID"},
                {"departments.error.validation", "Please check the department fields."},
                {"departments.error.duplicate", "A department with this name already exists."},
                {"departments.error.access_denied", "You do not have permission to manage departments."},
                {"departments.success.created", "Department created successfully."},
                {"departments.success.updated", "Department updated successfully."},
                ...
                {"dashboard.section.workspace", "Workspace"},
                {"dashboard.section.administration", "Administration"},
                {"dashboard.no_links", "No links available."},
                {"users.title", "Users"},
                ...
                {"admin.title", "Admin"},
                {"admin.diagnostics", "Application Diagnostics"},
                {"admin.roles.description", "Manage roles and authorization options."},
                {"admin.project_types.description", "Manage the project types available across the portal."},
                {"admin.diagnostics.description", "Open runtime diagnostics and developer tools."},
                {"admin.open", "Open"},
        ...
        },
        {
            "de",
            {
                ...
                {"departments.name", "Name"},
                {"departments.description", "Beschreibung"},
                {"departments.manager", "Leitung"},
                {"departments.active", "Aktiv"},
                {"departments.inactive", "Inaktiv"},
                {"departments.create", "Abteilung erstellen"},
                {"departments.search.clear", "Zurücksetzen"},
                {"departments.edit", "Bearbeiten"},
                {"departments.empty", "Keine Abteilungen gefunden."},
                {"departments.save", "Abteilung speichern"},
                {"departments.not_found", "Abteilung wurde nicht gefunden."},
                {"departments.details.title", "Abteilungsdetails"},
                {"departments.members", "Mitglieder"},
                {"departments.members.empty", "Diese Abteilung hat keine Mitglieder."},
                {"departments.members.add", "Mitglied hinzufügen"},
                {"departments.members.remove", "Entfernen"},
                {"departments.members.no_candidates", "Alle Benutzer gehören bereits zu dieser Abteilung."},
                {"departments.members.error.invalid", "Der ausgewählte Benutzer ist ungültig."},
                {"departments.members.error.duplicate", "Dieser Benutzer ist bereits Mitglied der Abteilung."},
                {"departments.members.error.not_found", "Das Abteilungsmitglied wurde nicht gefunden."},
                {"departments.members.success.added", "Mitglied hinzugefügt."},
                {"departments.members.success.removed", "Mitglied entfernt."},
                {"departments.back", "Zurück zu den Abteilungen"},
                {"departments.status", "Status"},
                {"departments.pagination.label", "Abteilungsseiten"},
                {"departments.filter.title", "Filter"},
                {"departments.filter.status", "Status"},
                {"departments.filter.all", "Alle Status"},
                {"departments.filter.active", "Aktiv"},
                {"departments.filter.inactive", "Inaktiv"},
                {"departments.sort.label", "Sortieren nach"},
                {"departments.sort.direction.label", "Richtung"},
                {"departments.sort.name", "Name"},
                {"departments.sort.manager", "Leitung"},
                {"departments.sort.active", "Status"},
                {"departments.sort.id", "ID"},
                {"departments.error.validation", "Bitte prüfen Sie die Abteilungsfelder."},
                {"departments.error.duplicate", "Eine Abteilung mit diesem Namen existiert bereits."},
                {"departments.error.access_denied", "Sie haben keine Berechtigung, Abteilungen zu verwalten."},
                {"departments.success.created", "Abteilung wurde erfolgreich erstellt."},
                {"departments.success.updated", "Abteilung wurde erfolgreich aktualisiert."},
                ...
                {"dashboard.quick_links", "Schnellzugriff"},
                {"dashboard.section.workspace", "Arbeitsbereich"},
                {"dashboard.section.administration", "Verwaltung"},
                {"dashboard.no_links", "Keine Links verfügbar."},
                ...
                {"admin.title", "Admin"},
                {"admin.diagnostics", "Anwendungsdiagnose"},
                {"admin.roles.description", "Rollen und Berechtigungsoptionen verwalten."},
                {"admin.project_types.description", "Die im Portal verfügbaren Projekttypen verwalten."},
                {"admin.diagnostics.description", "Laufzeitdiagnose und Entwicklerwerkzeuge öffnen."},
                {"admin.open", "Öffnen"},
