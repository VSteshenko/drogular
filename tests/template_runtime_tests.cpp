...
TEST(TemplateRuntimeTests, ResolvesEscapedVariable) {
...
TEST(TemplateRuntimeTests, ResolvesRawVariable) {
    drogular::RenderContext context;
...
TEST(TemplateRuntimeTests, ResolvesJsonPath) {
    drogular::RenderContext context;
...
TEST(TemplateRuntimeTests, EvaluatesBoolCondition) {
    drogular::RenderContext context;
...
TEST(TemplateRuntimeTests, EvaluatesJsonCondition) {
    drogular::RenderContext context;
...
TEST(TemplateRuntimeTests, ResolvesJsonValue) {
    drogular::RenderContext context;
