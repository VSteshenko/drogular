...
class CoreHttpGraphQLClientTestFixture : public ::testing::Test {
protected:
...
TEST_F(CoreHttpGraphQLClientTestFixture, ExecutesRequestAgainstServer) {
...
TEST_F(CoreHttpGraphQLClientTestFixture, ReadsGraphQLErrorsFromServer) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-error"
...
TEST_F(CoreHttpGraphQLClientTestFixture, ExecuteThrowsOnGraphQLErrors) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-error"
...
TEST_F(CoreHttpGraphQLClientTestFixture, SendsVariablesToServer) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-variables"
...
TEST_F(CoreHttpGraphQLClientTestFixture, ExecuteMapsResponseDataToGraphQLResult) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-success"
...
TEST_F(CoreHttpGraphQLClientTestFixture, ThrowsOnHttpErrorStatus) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-http-error"
...
TEST_F(CoreHttpGraphQLClientTestFixture, ThrowsOnInvalidJsonResponse) {
    drogular::HttpGraphQLClient client(
        TestHost,
        TestPort,
        "/graphql-invalid-json"
